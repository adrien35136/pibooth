...
DEFAULT = odict((
        ...
        odict((
            ...
            ("animate_delay",
                (0.2,
                 ...
                 "animate_delay", [str(i) for i in range (1,10,1)])),
            ...
            ("preview_alpha_value",
                (200,
                 "Alpha value of the countdown preview (transparency)",
                 "preview_alpha_value", [str(i) for i in range(0, 255, 5)])),
            ("preview_countdown",
                (True,
    ...
    ("PICTURE",
        odict((
            ...
            ("footer_text3",
                ("Footer 3",
                 "Third text displayed",
                 "Title3", "")),
            ("text_colors",
                ((0, 0, 0),
                 "RGB colors used for footer texts (list of tuples accepted)",
                 "text_colors", ["((0, 0, 0), (0, 0, 0), (0, 0, 0))", "((255, 255, 255), (255, 255, 255), (255, 255, 255))"], )),
            ("text_fonts",
            ...
            ("backgrounds",
                ((255, 255, 255),
                 ...
                 "backgrounds", ['(0, 0, 0)', '(255, 255, 255)', 'logo_anniversaire.png','logo_anniversaire2.png', 'logo_mariage.png', 'logo_mariage2.png'])),
            ("template", 
                ('pibooth_white_background.xml',
                 "Pictures template path : it should contain 8 pages (4 capture numbers and 2 orientations)",
                 "Pictures template path",  
                 ["pibooth_empty_background.xml",
                  'pibooth_white_background.xml',
                  'pibooth_birthday_background.xml',
                  'pibooth_birthday_generique_background.xml',
                  'pibooth_birthday_specific_name.xml',
                  'pibooth_wedding_specific_name.xml'
                 ])),
        ))
     ),
    ("CAMERA",
    ...
    ("CONTROLS",
        odict((
            ...
            ("flash_led_pin",
                (29,
                 "Physical GPIO OUT pin to control FLASH before taking picture",
                 None, None)),
            ("picture_btn_pin",
                (11,
